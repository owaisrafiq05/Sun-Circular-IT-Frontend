...
export default function WhatSetsUsApart() {
  const features = [
    {
      icon: <FaCertificate size={48} className="text-teal-600" />,
  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <h1 className="text-3xl lg:text-4xl font-bold text-teal-900 mb-8 text-center montserrat-bold">
          What Sets Us Apart
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-20 h-20 flex items-center justify-center bg-teal-100 rounded-full mb-4">
                {feature.icon}
              </div>
              <h3 className="text-teal-900 text-xl font-bold mb-2 montserrat-bold">
                {feature.title}
              </h3>
